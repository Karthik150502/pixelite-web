    ...
    return <>
        ...
        >
            <motion.div
                ...
                className='h-full w-fit flex items-center justify-center p-4 rounded-full border border-white/10 bg-black/20 backdrop-blur-xl gap-10 shadow-[0_8px_30px_-8px_rgba(61,7,69,0.35)] px-10'>
                {
